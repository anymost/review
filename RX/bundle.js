...
var observableOne = _rxjs.Observable.interval(1000);
var observableTwo = _rxjs.Observable.fromEvent(button, 'click');
// observableOne.buffer(observableTwo)
// .subscribe(value=>{
//     console.log(value);
// });
observableOne.bufferCount(5).subscribe(function (value) {
    console.log(value);
});
